...
taxonomy(){
	...
	echo -e "Global rank~$SW_GLOBALRANK~Similarweb"
	echo -e "Pageviews per visit~$SW_PAGEVIEWS~Similarweb"
	echo -e "Pageviews per visit~$SW_PAGEVIEWS~Similarweb"
	echo -e "Bouncerate (%)~$ALEXA_BOUNCERATE~Alexa"
	echo -e "Bouncerate (%)~$SW_BOUNCERATE~Similarweb"
	echo -e "Average visit length~$ALEXA_TIMEONSITE~Alexa,"
	echo -e "Average visit length~$SW_TIMEONSITE~Similarweb"
	echo -e "Direct traffic (%)~$SW_DIRECT~Similarweb"
	echo -e "Traffic from search (%)~$SW_SEARCH~Similarweb"
	echo -e "Traffic from other sites (%)~$SW_REFERRALS~Similarweb"
	echo -e "Traffic from social (%)~$SW_SOCIAL~Similarweb"
	echo -e "Paid search (% of search)~$SW_PAID_SEARCH~Similarweb"
	echo -e "Traffic from top keywords (%)~$ALEXA_TOPKEYWORDS~Alexa"
	echo -e "Traffic from search (%)~$ALEXA_SEARCHVISITS~Alexa"
	echo -e "Traffic from ad networks (%)~$SW_ADNETWORKS~Similarweb"
	echo -e "Traffic from email (%)~$SW_MAIL~Similarweb"
	echo -e "Top ad network partner~$SW_TOPADNETWORK~Similarweb"
	echo -e "Traffic from top counties (%)~$SW_TOPCOUNTRYSHARES~Similarweb"
	echo -e "Traffic from top countries (%),$ALEXA_TOPCOUNTRIES~Alexa"
	echo -e "Loadspeed~$ALEXA_LOADSPEED~Alexa"	
}
...
menu_item(){
	...
	echo -e "            <li class="active"><a href=traffic.html>traffic</a></li>"
