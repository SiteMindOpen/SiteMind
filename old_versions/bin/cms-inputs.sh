...
taxonomy(){
	...
	echo -e "14~paid search traffic's share of all search~"$SW_PAID_SEARCH"~Similarweb"
	echo -e "15~Trust~"$WOT_TRUST"~Web of Trust"
	echo -e "16~Childsafety~"$WOT_CHILDSAFETY"~Web of Trust"
