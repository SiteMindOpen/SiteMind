...
taxonomy(){
	echo -e "Top inbound referral~$SW_REFERRALSIN~Similarweb"
	echo -e "Top outbound referral~$SW_REFERRALSOUT~Similarweb"
	echo -e "Top5 inbound traffic sources~$SITES_UPSTREAM~compute"
